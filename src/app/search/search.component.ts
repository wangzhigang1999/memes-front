...
export class SearchComponent {
  ...
  searchByAuthor(author: string) {
    ...
    this.searchService.getByAuthor(author).subscribe((res: Post[]) => this.results.push(...res))
  ...
  searchByBoard(board: string) {
    ...
    this.searchService.getByBoard(board).subscribe((res: Post[]) => this.results.push(...res))
  }
  ...
  private searchByKeyword(keyword: string) {
    ...
    this.searchService.getByKeyword(keyword).subscribe((res: Post[]) => this.results.push(...res))
  }

  private getLatest(number: number) {
    this.searchService.getLatest(number).subscribe((res: Post[]) => this.results.push(...res))
  }
}
